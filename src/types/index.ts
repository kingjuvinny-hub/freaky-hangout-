...
export type Action =
  ...
  | { type: 'ADD_PLAYER'; payload: { name: string; avatar: string; title?: PlayerTitle, id?: string } }
  ...
  | { type: 'CREATE_ROOM'; payload: { player: Omit<Player, 'score' | 'streak'>; roomId: string } }
  | { type: 'JOIN_ROOM'; payload: { player: Omit<Player, 'score' | 'streak'> } }
