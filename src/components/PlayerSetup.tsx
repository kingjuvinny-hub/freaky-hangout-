    ...
    <div className="space-y-8 animate-fade-in">
      <div className="grid md:grid-cols-2 gap-8">
        <div className="bg-black/30 backdrop-blur-sm border border-[var(--border-color)] p-6 rounded-xl shadow-lg shadow-purple-900/20">
          ...
          <div className="mt-4 space-y-2 max-h-52 md:max-h-60 overflow-y-auto pr-2">
      ...
      <div className="text-center">
        <button
          ...
          className="bg-[var(--color-primary)] text-white font-black py-4 px-8 sm:px-16 text-xl sm:text-2xl rounded-lg transition-all transform hover:scale-105 disabled:bg-gray-600 disabled:cursor-not-allowed disabled:transform-none"
